...
function l(e3, r2) {
  return (s3 = r2) => {
    const o3 = p(), l3 = (0, import_react.useRef)(r2);
    return (0, import_lodash.isEqual)(l3.current, s3) || (l3.current = s3), { positions: (0, import_react.useCallback)(() => l3.current ? e3(o3.getGraph(), l3.current) : {}, [o3, l3]), assign: (0, import_react.useCallback)(() => {
      l3.current && e3.assign(o3.getGraph(), l3.current);
    }, [o3, l3]) };
  };
}
function c(e3) {
  return (r2) => {
    const l3 = p(), [c3, u3] = (0, import_react.useState)(false), [p3, g2] = (0, import_react.useState)(null), m2 = (0, import_react.useRef)();
    return (0, import_lodash.isEqual)(m2.current, r2) || (m2.current = r2), (0, import_react.useEffect)(() => {
      u3(false);
      let t2 = null;
      return m2.current && (t2 = new e3(l3.getGraph(), m2.current)), g2(t2), () => {
        null !== t2 && t2.kill();
      };
    }, [l3, m2, g2, u3]), { stop: (0, import_react.useCallback)(() => {
      p3 && (p3.stop(), u3(false));
    }, [p3, u3]), start: (0, import_react.useCallback)(() => {
      p3 && (p3.start(), u3(true));
    }, [p3, u3]), kill: (0, import_react.useCallback)(() => {
      p3 && p3.kill(), u3(false);
    }, [p3, u3]), isRunning: c3 };
  };
}
var u;
function p2() {
  return p2 = Object.assign ? Object.assign.bind() : function(t2) {
...
var g;
var m = function(t2) {
  return e.createElement("svg", p2({ "aria-hidden": "true", "data-prefix": "fas", "data-icon": "play", className: "play-solid_svg__svg-inline--fa play-solid_svg__fa-play play-solid_svg__fa-w-14", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", width: "1em", height: "1em" }, t2), u || (u = e.createElement("path", { fill: "currentColor", d: "M424.4 214.7 72.4 6.6C43.8-10.3 0 6.1 0 47.9V464c0 37.5 40.7 60.1 72.4 41.3l352-208c31.4-18.5 31.5-64.1 0-82.6z" })));
};
function f() {
...
var d = function(t2) {
  return e.createElement("svg", f({ "aria-hidden": "true", "data-prefix": "fas", "data-icon": "stop", className: "stop-solid_svg__svg-inline--fa stop-solid_svg__fa-stop stop-solid_svg__fa-w-14", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", width: "1em", height: "1em" }, t2), g || (g = e.createElement("path", { fill: "currentColor", d: "M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z" })));
};
function h({ id: t2, className: e3, style: a2, layout: n2, settings: s3, autoRunFor: l3, children: c3, labels: u3 = {} }) {
  const p3 = p(), { stop: g2, start: f2, isRunning: h2 } = n2(s3), v = { className: `react-sigma-control ${e3 || ""}`, id: t2, style: a2 };
  return (0, import_react.useEffect)(() => {
    if (!p3) return;
    let t3 = null;
    return void 0 !== l3 && l3 > -1 && p3.getGraph().order > 0 && (f2(), t3 = l3 > 0 ? window.setTimeout(() => {
      g2();
    }, l3) : null), () => {
      t3 && clearTimeout(t3);
    };
  }, [l3, f2, g2, p3]), import_react.default.createElement("div", Object.assign({}, v), import_react.default.createElement("button", { onClick: () => h2 ? g2() : f2(), title: h2 ? u3.stop || "Stop the layout animation" : u3.start || "Start the layout animation" }, c3 && !h2 && c3[0], c3 && h2 && c3[1], !c3 && !h2 && import_react.default.createElement(m, { style: { width: "1em" } }), !c3 && h2 && import_react.default.createElement(d, { style: { width: "1em" } })));
}
...
var c2 = ({ id: o3, className: t2, style: a2, settings: e3 = {}, autoRunFor: l3, children: c3, labels: y }) => {
  const i = { id: o3, className: t2, style: a2, settings: e3, autoRunFor: l3, labels: y, layout: u2 };
